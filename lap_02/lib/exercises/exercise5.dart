...
// Helper function returning nullable String
String? getNullableName(bool returnNull) {
  return returnNull ? null : 'Bob';
}
...
void main() async {
  ...
  String? nullableName = getNullableName(true); // nullable variable (null)
  ...
  // Using non-null value to demonstrate ?. and ! operators
  String? validName = getNullableName(false);
  print('Safe access with ?. operator length: ${validName?.length}');
  print('Null assertion with ! operator: ${validName!.toUpperCase()}\n');
